...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyLoginNewPage(title: 'Flutter Demo Home Page'),
    );
  }
}

class MyLoginNewPage extends StatefulWidget {
  const MyLoginNewPage({super.key, required this.title});
  ...
  @override
  State<MyLoginNewPage> createState() => _MyLoginNewPageState();
}

class _MyLoginNewPageState extends State<MyLoginNewPage> {
                      ...
                      children: <Widget>[
                        ...
                        TextButton(onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context) => ForgotpasswordPage(title: "Forgot Password"),));
                          // _send_data();
